        ...
        <Box className={classes.backgroundContent}>
            <Grid container direction="row" justify="space-evenly" alignItems="center">
                <Grid container item direction="column" justify="flex-start" alignItems="center" sm={5} spacing={4}>
                    <Grid item>
                        <a href="https://t.me/mari_vinogradova">
                ...
                <Grid item justify="space-evenly" alignItems="center" sm={5} style={{padding: 0}}>
                    <Paper variant="outlined" className={classes.contactsField}>
                        <Typography variant="h6" className={classes.coolTitle} align="center">
                            Присоединяйся к курсу креативного мышления прямо сейчас
                        </Typography>
                        <form className={classes.formRoot} noValidate autoComplete="off">
                            <Grid container direction="column" justify="space-evenly" alignItems="center" align="center"
                                  className={classes.formRoot}>
                                <TextField id="text-name" label="Как к вам обращаться?" fullWidth align="center"
                                           variant="outlined" className={classes.formItem} color="#89A4D7"/>
                                <TextField id="text-email" label="Введите вашу почту" fullWidth align="center"
                                           variant="outlined" className={classes.formItem} color="#89A4D7"/>
                                <Button variant="contained" size="large" className={classes.formSubmit}>Получить
                                    инсайт</Button>
                            </Grid>
                        </form>
                    </Paper>
